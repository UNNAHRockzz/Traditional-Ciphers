...
lab2=Label(text="Derypted Text 👉", font="20", bg="#181818", fg="white")
...
caesar_encrypt = Button(root , text="Caesar Decrypt" , command=lambda:ciesar(input_text.get(1.0, END)), bg="#000000", fg="#38E54D" ,height=2 , width=15)
caesar_encrypt.grid(column=0, row=1)

mono_encrypt= Button(root , text="Monoalphabetic Decrypt" , command=lambda:monoalphabetic(input_text.get(1.0, END)),bg="#000000", fg="#38E54D" ,height=2 , width=20)
mono_encrypt.grid(column=2, row=1)

rev_encrypt = Button(root , text="Reverse Decrypt" , command=lambda:reverse(input_text.get(1.0, END)),bg="#000000", fg="#38E54D" ,height=2 , width=15)
